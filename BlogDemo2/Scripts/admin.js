$(function () {
    ...
    BlogDemo2.GridManager = {};

    //************************* POSTS GRID
    BlogDemo2.GridManager.postsGrid = function (gridName, pagerName) {
        ...
        var addOptions = {
            ...
            onClose: onClose,
            afterSubmit: BlogDemo2.GridManager.afterSubmitHandler,
    ...
    //************************* CATEGORIES GRID
    BlogDemo2.GridManager.categoriesGrid = function (gridName, pagerName) {
    ...
    //************************* TAGS GRID
    BlogDemo2.GridManager.tagsGrid = function (gridName, pagerName) {
        var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
    ...
    BlogDemo2.GridManager.afterSubmitHandler = function (response, postdata) {
    ...
    $("#tabs").tabs({
        show: function (event, ui) {
            ...
            if (!ui.tab.isLoaded) {
                ...
                var gdMgr = BlogDemo2.GridManager,
